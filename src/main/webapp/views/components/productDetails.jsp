<div class="ui text two column grid container jsProductDetailsComponent">
    ...
    <div class="column">
        ...
        <div class="ui one column grid">
            <p>This is design and technology taken to a whole new level. Artisan materials and striking craftsmanship create an experience unlike anything else. With a breathtaking composition that's 10.4 mm thin and full Intel® Core™ i5 or i7 power, this luxurious Laptop is completely irresistible.</p>
        </div>
    </div>
</div>
